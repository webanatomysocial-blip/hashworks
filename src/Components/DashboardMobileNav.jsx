  ...
  return (
    <nav className="mobile-nav" data-role={isHirer ? "hirer" : "worker"}>
      ...
      <Link
        ...
        className={`mobile-nav-item ${pathname === (isHirer ? "/hirer" : "/worker") ? "active" : ""}`}
      >
      ...
      {isHirer ? (
        ...
        <Link
          href="/worker/browse"
          className={`mobile-nav-item ${pathname === "/worker/browse" ? "active" : ""}`}
        >
          <div className="nav-icon-wrap">
            <svg
              width="24"
      ...
      {isHirer ? (
        <div className="mobile-nav-item">
          <Link
            href="/hirer/profile/"
            className={`mobile-nav-item ${pathname === "/hirer/profile" ? "active" : ""}`}
          >
            <div className="nav-icon-wrap">
              <svg
                width="24"
        ...
        <Link
          href="/worker/profile/"
          className={`mobile-nav-item ${pathname === "/worker/profile" ? "active" : ""}`}
        >
          <div className="nav-icon-wrap">
            <svg
              width="24"
